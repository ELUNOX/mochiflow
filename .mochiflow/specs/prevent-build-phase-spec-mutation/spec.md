...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AC-01 | cli | automated | `mochiflow lint --spec prevent-build-phase-spec-mutation`; source review of `engine/commands/build.md` | `engine/commands/build.md` | UNVERIFIED |  |  |
| AC-02 | cli | automated | `mochiflow lint --spec prevent-build-phase-spec-mutation`; source review of `engine/commands/build.md` | `engine/commands/build.md` | UNVERIFIED |  | No drift detection in scope. |
| AC-03 | cli | automated | `mochiflow lint --spec prevent-build-phase-spec-mutation`; source review of authoring/template docs | `engine/reference/authoring.md`, `engine/templates/spec/tasks.md` | UNVERIFIED |  |  |
| AC-04 | cli | automated | Targeted cargo test plus final default verification | `cli/crates/mochiflow-cli/tests/conformance.rs`, optional `cli/crates/mochiflow-core/src/lint.rs` | UNVERIFIED |  |  |
| AC-05 | cli | automated | `mochiflow freeze`; `mochiflow upgrade --source engine`; `mochiflow adapter generate --check`; default verification | `engine/MANIFEST.json`, `.mochiflow/engine/**` | UNVERIFIED |  |  |
