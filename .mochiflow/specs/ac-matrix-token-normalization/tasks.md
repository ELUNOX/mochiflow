...
- [ ] T-001 [AC-01, AC-02, AC-03, AC-04] Add `CONFIRMED` and `N/A:` done-eligibility to lint.rs and update error messages
  - Depends on: none
...
- [ ] T-006 [AC-05, AC-10] Update conformance tests, regenerate MANIFEST, and run full verification
