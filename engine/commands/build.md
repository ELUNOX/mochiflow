...
3. **Task loop**: repeat 3a–3e for each open task.
   ...
   - 3b. Append seam decisions / ownership / dead-code handling to `design.md ## 統合ログ` only when `design.md` exists and the integration-log column in `reference/risk.md` calls for it. For `standard`, do not create or require `design.md ## 統合ログ`.
